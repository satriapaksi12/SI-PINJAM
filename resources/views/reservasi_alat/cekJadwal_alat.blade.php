...
@section('title', 'Cek Jadwal Reservasi Alat')
@section('fitur', 'CEK JADWAL RESERVASI ALAT')
@section('link', '/cek-jadwal-reservasi-alat')
@section('nama link', 'Cek Jadwal Reservasi Alat')
