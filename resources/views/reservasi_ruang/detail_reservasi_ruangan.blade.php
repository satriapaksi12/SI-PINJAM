                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            ...
                                            class="form-control" value="{{ $reservasi_ruang->status }}" readonly>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" name="status"id="status"
                                            class="form-control" value="{{ $reservasi_ruang->alasan }}" readonly>
                                        </div>
                                        <div class="col-sm-12 d-flex justify-content-end">
                                            <a href="/detail-reservasi-ruang-cetak/{{$reservasi_ruang->id}}" ><button type="submit" class="btn btn-primary me-1 mb-1">Cetak Bukti Reservasi</button></a>
                                        </div>
                                    </div>
                                </div>
