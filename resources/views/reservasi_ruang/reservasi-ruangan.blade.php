                    ...
                    <div class="card-body">
                        ...
                        <form id="cekKetersediaanForm" action="{{ route('prosesCekKetersediaanRuang') }}" method="GET"
                            ...
                            <div class="col-md-8 form-group">
                                <input type="date" name="cek_tanggal_mulai" id="cek_tanggal_mulai"
                                    class="form-control">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="date" onchange="checkTanggalMulai()"
                                    name="cek_tanggal_selesai"id="cek_tanggal_selesai" class="form-control">
                            </div>
                            <div class="col-md-4">
                                <label>Sesi</label>
                            </div>
                                ...
                                $('#cekKetersediaanForm').submit(function(event) {
                                    ...
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            // $('#cardContainer').empty();
                                            console.log(response.data.nama_ruang);
