    ...
    <section class="section">
        <div class="card">
            <div class="card-header flex-container">
                ...
                <a href="/export-unit" class="btn btn-success">Export Excel</a>
                        ...
                        @foreach ($unitList as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="unit-edit/{{ $data->id }}" title="Edit" class="btn icon btn-warning"><i
                                ...
                                <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form id="import-form" action="/import-unit" method="POST"
