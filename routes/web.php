...
->middleware(['auth', 'forbidden-umum-or-mahasiswa']);
Route::get('/reservasi-kendaraan-add/{id}', [ReservasiKendaraanController::class, 'create'])
->middleware(['auth', 'forbidden-umum-or-mahasiswa']);
Route::post('/reservasi-kendaraan', [ReservasiKendaraanController::class, 'store'])
->middleware(['auth', 'forbidden-umum-or-mahasiswa']);
Route::get('/cekKesediaan-reservasi_kendaraan', [ReservasiKendaraanController::class, 'cekKesediaan'])
->middleware(['auth', 'forbidden-umum-or-mahasiswa'])->name('prosesCekKetersediaanKendaraan');

//Kelola reservasi kendaraan
Route::get('/kelola-reservasi-kendaraan', [ReservasiKendaraanController::class, 'kelolaReservasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
Route::get('/validasi-reservasi-kendaraan/{id}', [ReservasiKendaraanController::class, 'validasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
Route::put('/validasi-reservasi-kendaraan/{id}', [ReservasiKendaraanController::class, 'simpanValidasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
Route::get('/detail-reservasi-kendaraan/{id}', [ReservasiKendaraanController::class, 'detailReservasi'])
->middleware(['auth', 'forbidden-umum-or-mahasiswa']);
//cetak reservasi kendaraan
Route::get('/detail-reservasi-kendaraan-cetak/{id}', [ReservasiKendaraanController::class, 'cetakReservasi'])
->middleware(['auth', 'forbidden-umum-or-mahasiswa']);
//Daftar reservasi kendaraan
Route::get('/daftar-reservasi-kendaraan', [ReservasiKendaraanController::class, 'daftarReservasi'])
->middleware(['auth', 'forbidden-umum-or-mahasiswa']);
//Cek jadwal reservasi kendaraan
Route::get('/cekJadwal_kendaraan', [ReservasiKendaraanController::class, 'cekJadwal'])->middleware('auth');
//export dan import reservasi kendaraan
Route::get('/export-reservasi_kendaraan', [ReservasiKendaraanController::class, 'exportReservasiKendaraans'])
->middleware(['auth', 'must-superadmin-or-admin']);
Route::post('/import-reservasi_kendaraan', [ReservasiKendaraanController::class, 'importReservasiKendaraans'])
->middleware(['auth', 'must-superadmin-or-admin']);
...
Route::get('/cekKesediaan-reservasi_alat', [ReservasiAlatController::class, 'cekKesediaan'])
->middleware(['auth', 'forbidden-umum'])->name('prosesCekKetersediaanAlat');
//kelola reservasi alat
Route::get('/kelola-reservasi-alat', [ReservasiAlatController::class, 'kelolaReservasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
Route::get('/validasi-reservasi-alat/{id}', [ReservasiAlatController::class, 'validasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
Route::put('/validasi-reservasi-alat/{id}', [ReservasiAlatController::class, 'simpanValidasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
...
//Reservasi  ruangan
Route::get('/reservasi-ruang', [ReservasiRuangController::class, 'index'])
->middleware(['auth', 'forbidden-umum']);
Route::get('/reservasi-ruang-add/{id}', [ReservasiRuangController::class, 'create'])
->middleware(['auth', 'forbidden-umum']);
Route::post('/reservasi-ruang', [ReservasiRuangController::class, 'store'])
->middleware(['auth', 'forbidden-umum']);
Route::get('/cekKesediaan-reservasi_ruang', [ReservasiRuangController::class, 'cekKesediaan'])
->middleware(['auth', 'forbidden-umum'])->name('prosesCekKetersediaanRuang');

//kelola reservasi ruangan
Route::get('/kelola-reservasi-ruang', [ReservasiRuangController::class, 'kelolaReservasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
Route::get('/validasi-reservasi-ruang/{id}', [ReservasiRuangController::class, 'validasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
Route::put('/validasi-reservasi-ruang/{id}', [ReservasiRuangController::class, 'simpanValidasi'])
->middleware(['auth', 'must-superadmin-or-admin']);
